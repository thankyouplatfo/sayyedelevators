...
@section('content')
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <div class="w3-container w3-padding-32" id="contact">
            <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">اتصل بنا</h3>
            <p>عروض الأسعار أو الشكاوى والإقتراحات وغير ذلك تواصل معنا.</p>
        ...
        <div class="w3-container">
            <img src="{{ asset('images/site/map/1.png') }}" class="w3-image" style="width:100%">
        </div>
